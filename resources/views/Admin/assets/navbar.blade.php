            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="users" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.teacher.view')}}"> All Teachers </a>
                        </li>
                        <li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="elements" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.faq.view')}}"> All FAQs </a>
                        </li>
                        <li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="pages" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.slider.view')}}"> All Images </a>
                        </li>
                        <li>
                            <a href="{{route('admin.slider.create')}}"> Add Image </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="datatables" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.activity.view')}}"> All Activities </a>
                        </li>
                        <li>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin.course.view')}}"> All Courses </a>
                        </li>
                        <li>
                ...
                <li class="menu">
                    ...
                    <a href="{{route('admin.contact.view')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                            <span>Contacts</span>
                        </div>
